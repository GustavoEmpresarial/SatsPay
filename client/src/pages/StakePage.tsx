...
/** Stake — apenas landing “Em breve” (sem simulador / moedas / ações). */
    ...
    <div className="mx-auto max-w-3xl space-y-6 pb-12">
          ...
          <div>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="text-xs font-bold text-ink">
                Protocolo em Fase Final de Auditoria de Smart Contracts
              </span>
            </div>
            <p className="mt-1 text-xs leading-relaxed text-ink-muted">
              A delegação automatizada para os validadores Jito (SOL), Lido (POL) e Yearn V3
              (USDT/USDC) será liberada em breve.
            </p>
          </div>
        </div>
      ...
      >
        ...
        <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-ink-muted">
          Liquid staking e yield vaults (Jito · Lido · Yearn) estão em auditoria. Esta área
          abrirá quando a integração on-chain estiver liberada — sem depósito nem simulação por
          agora.
        </p>
