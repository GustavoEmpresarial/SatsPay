...
| Slug | `cookies` |
| Título | Cookies |
| Componente | `CookiesPage` |
| Auth | **public** — rota pública |
| UI pt-BR | Admin sempre pt-BR hardcoded; app usuário usa i18n |

## Keywords (busca)

`cookies CookiesPage /cookies   public`
...
- `client/src/pages/CookiesPage.tsx`
- `docs/pages/cookies/`

## Comportamento (bruto)

Página React `CookiesPage`. Chama 0 endpoint(s) via `api()`.
...
Página **Cookies** (`CookiesPage.tsx`).
